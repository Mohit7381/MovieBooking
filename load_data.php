...
$result_pag_data = myslqi_query($query_pag_data);

$msg = '<table class="data">';
            while($row=myslqi_fetch_array($result_pag_data))
            {
$msg.= '<tr>
              <td id="leftcontents">
...
$result_pag_num = myslqi_query($query_pag_num);
$row = myslqi_fetch_array($result_pag_num);
$count = $row['count'];
