...
$query1=myslqi_query("SELECT * FROM theatres WHERE name='$theatre_name' ");
...
{
	$query = myslqi_query("INSERT INTO theatres VALUES('','$theatre_name','$addr','$location_id','$email','$mobile','1','1','1')");
    $getId = myslqi_insert_id();

if($query)
{
	$login_query = myslqi_query("INSERT INTO theatre_login VALUES('','$uname','$psswd','$getId')");
